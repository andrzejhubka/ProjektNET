...
namespace ProjektZaliczeniowyNET.Models
{
    ...
    public class ServiceOrder
    {
        ...
        [Required] [StringLength(20)] public string OrderNumber { get; set; } = string.Empty;
        ...
        [Column(TypeName = "decimal(10,2)")] public decimal EstimatedCost { get; set; }

        [Column(TypeName = "decimal(10,2)")] public decimal FinalCost { get; set; }

        [StringLength(1000)] public string? CustomerComplaints { get; set; }

        [StringLength(1000)] public string? InternalNotes { get; set; }
        ...
        [ForeignKey("AssignedMechanicId")] public virtual User? AssignedMechanic { get; set; }
        ...
        public decimal TotalCost => TotalLaborCost;
    }
}